...
char pass[] = "ESP8266_AT_PW";        // your network password
#elif ESP8266_AT_USE_NRF528XX
char ssid[] = "ESP8266_AT_NRF52";     // your network SSID (name)
char pass[] = "ESP8266_AT_PW";        // your network password
#elif ESP8266_AT_USE_SAM_DUE
char ssid[] = "ESP8266_AT_SAMDUE";    // your network SSID (name)
char pass[] = "ESP8266_AT_PW";        // your network password
#elif ESP8266_AT_USE_STM32
char ssid[] = "ESP8266_AT_STM32";     // your network SSID (name)
char pass[] = "ESP8266_AT_PW";        // your network password
#else
